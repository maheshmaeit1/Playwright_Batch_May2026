...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  31812 pixels (ratio 0.04 of all image pixels) are different.
...
Call log:
  ...
  - fonts loaded
  - 38959 pixels (ratio 0.05 of all image pixels) are different.
  - waiting 100ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 7793 pixels (ratio 0.01 of all image pixels) are different.
