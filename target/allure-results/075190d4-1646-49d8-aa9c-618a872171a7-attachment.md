...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  30436 pixels (ratio 0.04 of all image pixels) are different.
...
Call log:
  ...
  - fonts loaded
  - 37468 pixels (ratio 0.05 of all image pixels) are different.
  - waiting 100ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 7858 pixels (ratio 0.01 of all image pixels) are different.
