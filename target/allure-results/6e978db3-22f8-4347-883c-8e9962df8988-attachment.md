...
```
Error: A snapshot doesn't exist at C:\Users\mahes\Desktop\NeuralQA\Playwright_Batch_27_April\Wokspace\Playwright_POM_Framework\tests\loginTest.spec.ts-snapshots\laptopLogo-chromium-win32.png, writing actual.
```
...
```ts
  ...
  39 | 
  40 |     const laptopImg = page.locator("(//a[@title='Show details for 14.1-inch Laptop']/img)[1]");
