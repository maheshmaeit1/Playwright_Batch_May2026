...
```
Error: A snapshot doesn't exist at C:\Users\mahes\Desktop\NeuralQA\Playwright_Batch_27_April\Wokspace\Playwright_POM_Framework\tests\loginTest.spec.ts-snapshots\laptopLogo-chromium-win32-chromium-win32.png, writing actual.
```
