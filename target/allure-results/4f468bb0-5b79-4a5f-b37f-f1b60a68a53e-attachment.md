...
Locator: locator('xpath=(//a[@title=\'Show details for Build your own cheap computer\']/img)[1]')
  1226 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: laptopLogo-chromium-win32.png

Call log:
  - Expect "toHaveScreenshot(laptopLogo-chromium-win32.png)" with timeout 5000ms
...
> 41 |     await expect(laptopImg).toHaveScreenshot('laptopLogo-chromium-win32.png');
     |                             ^ Error: expect(locator).toHaveScreenshot(expected) failed
  42 | 
  43 | });
  44 | 
