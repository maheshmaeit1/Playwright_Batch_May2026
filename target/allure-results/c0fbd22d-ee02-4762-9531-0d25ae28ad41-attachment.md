...
```
Error: A snapshot doesn't exist at C:\Users\mahes\Desktop\NeuralQA\Playwright_Batch_27_April\Wokspace\Playwright_POM_Framework\tests\loginTest.spec.ts-snapshots\Login-test-case-for-app--1-1-chromium-win32.png, writing actual.
```
